...
![Build](https://github.com/NHSDigital/mock-jwks/workflows/Build/badge.svg?branch=master)

This is a specification for the *mock-jwks* API.
...
## Contributing
Contributions to this project are welcome from anyone, providing that they conform to the [guidelines for contribution](https://github.com/NHSDigital/mock-jwks/blob/master/CONTRIBUTING.md) and the [community code of conduct](https://github.com/NHSDigital/mock-jwks/blob/master/CODE_OF_CONDUCT.md).
...
Telling Apigee how to connect to your backend requires a *Target Server*, which you should call named `mock-jwks-target`.
